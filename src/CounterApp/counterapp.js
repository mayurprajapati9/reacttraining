  ...
  // }
      ...
      render() {
        ...
        <h2> Task 1-Counter App </h2>
          ...
          <button className='p-2 bg-slate-200 px-10 rounded font-semibold m-1'  onClick={this.incerement.bind(this)}name="inc">++</button>
          <button className='p-2 bg-slate-200 px-10 rounded font-semibold m-1'  onClick={this.decrement.bind(this)} name ="dec">--</button>
          <button className='p-2 bg-slate-200 px-10 rounded font-semibold m-1'  onClick={this.btnReset.bind(this)}>Reset Counter </button>
