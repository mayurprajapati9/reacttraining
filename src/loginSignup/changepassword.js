...
class ChangePassword extends Component {
  ...
  render() {
    ...
    return (
      <center className="flex flex-col w-fit mt-5">
        ...
        <input
          ...
          className='border-2 border-black p-1 rounded ml-2'
        /><br />
        <input className='p-2 bg-slate-200 px-10 rounded font-semibold' type='button' value="Change Password" onClick={this.handleChangePassword} />&nbsp;
        <br />
